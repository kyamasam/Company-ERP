                    ...
                    <div id="sidebar-menu">
                        <ul>
                            ...
                            <li className="has_sub">
                                <a href="javascript:void(0);" className="waves-effect"><i className="ti-home"/>
                            ...
                            <li className="has_sub">
                                <a href="javascript:void(0);" className="waves-effect"><i className="ti-paint-bucket"/>
                                    <span> UI Kit </span> <span className="menu-arrow"/> </a>
                                <ul className="list-unstyled">
                            ...
                            <li className="has_sub">
                                <a href="javascript:void(0);" className="waves-effect"><i
                                    className="ti-light-bulb"/><span
                                    className="label label-primary pull-right">10</span><span> Components </span> </a>
                                <ul className="list-unstyled">
                            ...
                            <li className="has_sub">
                                <a href="javascript:void(0);" className="waves-effect"><i className="ti-spray"/>
                            ...
                            <li className="has_sub">
                                <a href="javascript:void(0);" className="waves-effect"><i
                                    className="ti-pencil-alt"/><span> Forms </span> <span className="menu-arrow"/></a>
                                <ul className="list-unstyled">
                            ...
                            <li className="has_sub">
                                <a href="javascript:void(0);" className="waves-effect"><i
                                    className="ti-menu-alt"/><span>Tables </span> <span className="menu-arrow"/></a>
                                <ul className="list-unstyled">
                            ...
                            <li className="has_sub">
                                <a href="javascript:void(0);" className="waves-effect"><i
                                    className="ti-bar-chart"/><span
                                    className="label label-pink pull-right">11</span><span> Charts </span></a>
                                <ul className="list-unstyled">
                            ...
                            <li className="has_sub">
                                <a href="javascript:void(0);" className="waves-effect"><i
                                    className="ti-location-pin"/><span> Maps </span> <span className="menu-arrow"/></a>
                                <ul className="list-unstyled">
                            ...
                            <li className="has_sub">
                                <a href="javascript:void(0);" className="waves-effect"><i
                                    className="ti-files"/><span> Pages </span> <span className="menu-arrow"/></a>
                                <ul className="list-unstyled">
                            ...
                            <li className="has_sub">
                                <a href="javascript:void(0);" className="waves-effect"><i
                                    className="ti-gift"/><span> Extras </span> <span className="menu-arrow"/></a>
                                <ul className="list-unstyled">
                            ...
                            <li className="has_sub">
                                <a href="javascript:void(0);" className="waves-effect"><i className="ti-crown"/><span
                                    className="label label-success pull-right">3</span><span> Apps </span></a>
                                <ul className="list-unstyled">
                            ...
                            <li className="has_sub">
                                <a href="javascript:void(0);" className="waves-effect"><i
                                    className="ti-email"/><span> Email </span> <span className="menu-arrow"/></a>
                                <ul className="list-unstyled">
                            ...
                            <li className="has_sub">
                                <a href="javascript:void(0);" className="waves-effect"><i
                                    className="ti-widget"/><span> Layouts </span> <span className="menu-arrow"/></a>
                                <ul className="list-unstyled">
                            ...
                            <li className="has_sub">
                                <a href="javascript:void(0);" className="waves-effect"><i className="ti-share"/><span>Multi Level </span>
                                    <span className="menu-arrow"/></a>
                                <ul>
                                    <li className="has_sub">
                                        <a href="javascript:void(0);"
                                           className="waves-effect"><span>Menu Level 1.1</span> <span
                            ...
                            <li className="has_sub">
                                <a href="javascript:void(0);" className="waves-effect"><i
                                    className="ti-user"/><span> Crm </span> <span className="menu-arrow"/></a>
                                <ul className="list-unstyled">
                            ...
                            <li className="has_sub">
                                <a href="javascript:void(0);" className="waves-effect"><i className="ti-shopping-cart"/><span
                                    className="label label-warning pull-right">6</span><span> eCommerce </span></a>
                                <ul className="list-unstyled">
